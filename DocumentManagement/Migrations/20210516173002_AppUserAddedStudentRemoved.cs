...
{
    public partial class AppUserAddedStudentRemoved : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserFaculty", x => new { x.ApplicationUsersId, x.FacultiesFacultyId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserFaculty_AspNetUsers_ApplicationUsersId",
                        column: x => x.ApplicationUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserFaculty_Faculties_FacultiesFacultyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserFaculty_FacultiesFacultyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StudentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BirthDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DadFirstNameInitial = table.Column<string>(type: "nvarchar(max)", nullable: true),
